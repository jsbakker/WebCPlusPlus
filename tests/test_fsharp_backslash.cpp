// test_fsharp_backslash.cpp
// Ported from FSharpBackslashContinuationTests.swift

#include <gtest/gtest.h>
#include "highlight_test_helper.h"

struct FSharpBackslashTest : ::testing::Test {
    std::string hl(const std::string& src) { return highlight(src, "fs"); }
};

TEST_F(FSharpBackslashTest, OpeningLineHasClosedFontTag) {
...
TEST_F(FSharpBackslashTest, ContinuationLineIsColoured) {
    auto html = hl("let s = \"hello \\\n    world\"");
    auto lines = splitLines(html);
